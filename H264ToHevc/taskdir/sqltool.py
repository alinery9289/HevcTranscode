...
engine=create_engine("mysql+mysqldb://"+MyConfig.conf_dic['mysql']['username']+":"+MyConfig.conf_dic['mysql']['password']+"@"+MyConfig.conf_dic['mysql']['ip']+"/"+MyConfig.conf_dic['mysql']['db'])
